...
food = {
    ...
    packages = {
        ...
        },
        {
            os = "linux",
            arch = "amd64",
            url = "https://github.com/NoUseFreak/sdf/releases/download/0.3.2/linux_amd64.zip",
        ...
        },
        {
            os = "windows",
            arch = "amd64",
            url = "https://github.com/NoUseFreak/sdf/releases/download/0.3.2/windows_amd64.zip",
